...
function Heade({ setIsOpen, IsOpen }) {
  ...
  return (
    <div className="bg-white dark:bg-[#212529] transition-colors duration-300 py-3 ">
      <div className="flex md:justify-end justify-between items-center border-b md:px-8 px-4 border-slate-900 dark:border-slate-700 py-2 transition-colors duration-300">
        {/* Mobile view */}
